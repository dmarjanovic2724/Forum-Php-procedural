...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    } elseif (strlen($_POST['topicName']) < 5 || strlen($_POST['topicName']) > 50) {
        $validated = true;
        $message = "topicName must be between 5 and 50 characters";
    } else {
...
<table class="topic-header">
    <tr>
        <td class="topic-name"><?php echo $catName ?></td>
    </tr>
    <tr>
        <td class="topic-description"><?php echo $catDescription ?></td>
    </tr>
</table>
